...
def save_annotations(app, campaign_id, annotation_set, annotator_id, user_id= ''):
    ...
    if annotator_id == PREVIEW_STUDY_ID:
        preview_message = f'<div class="alert alert-info" role="alert"><p>You are in a preview mode. This message will not be displayed to the annotators.</i></p></div>'
