...
def create_llm_campaign(app, mode, campaign_id, config, campaign_data, datasets, setup_id="", overwrite=False): #custom-factgenie ONELINE
    ...
    try:
        ...
        db = generate_llm_campaign_db(app, mode, datasets, campaign_id, campaign_data,setup_id ) #custom-factgenie ONELINE
...
def generate_llm_campaign_db(app, mode, datasets, campaign_id, campaign_data,setup_id1):
    # load all outputs
    all_examples = []
